...
%let geo_level = year state puma2012;
%let geolist ="year", "state", "puma2012";
%let lastgeo= puma2012;
...
data aa; 
  set cross.census2000topuma2010;
  afact1 = afact*1;
run;
...
data aa; 
  set cross.census2010topuma2010;
  afact1 = afact*1;
run;
