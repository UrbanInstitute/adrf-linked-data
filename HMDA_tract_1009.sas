...
%let geo_level = year state county_State tract2010;
%let geolist ="year", "state", "county_State" "tract2010";
%let lastgeo= tract2010;
...
data aa; 
  set cross.census2000tocensus2010;
  afact1 = afact*1;
run;
...
select 
   a.*
  ,b.tract10  as tract2010
  ,b.afact1 as afact

from HMDAA_&year. a 
inner join  aa b
on (a.county_State =b.county2k and a.tract = b.tract2k)
;
